...
const data = {
  ...
  projects: [
    ...
    },
    {
      ...
      name: 'LoM DB',
      position: 'Creator/Maintainer',
      link: 'https://lomdb.github.io',
      linkTitle: 'LoM DB :: Website',
      description: [
        ...
        'Developed using native Web Components to ensure modularity, framework-agnostic integration, and encapsulated behavior.',
        'Implemented animated SVG illustrations and visualizations to represent server merges, player rankings, and other dynamic data.',
        'Leveraged Three.js for 3D visual elements and interactive, engaging UI experiences.',
        // 'Used modern CSS features including variables and nesting for responsive, maintainable layouts.',
        // 'Integrated automated testing with Vitest to ensure component stability and consistent behavior across updates.',
        'Built a custom task manager using Node.js to handle data aggregation, processing, and visualization generation.',
        // 'Optimized for performance, minimal runtime overhead, and cross-browser compatibility.',
