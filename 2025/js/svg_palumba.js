...
customElements.define(
  ...
  class extends HTMLElement {
    ...
    #template = `
<svg width="380" height="340" viewBox="0 0 211.667 211.667">
  <title>Palumba animation</title>
  <g class="leg-left">
...
`
    ...
    #directionsType = [`left`, `right`].map(direction => getPrefix(direction))

    updateDirection() {
      this.classList.remove(...this.#directionsType)
      const directionAttr = getPrefix(this.getAttribute('direction'))

      if (this.#directionsType.includes(directionAttr)) {
