...
Added storybook and migrated documentation to it.

## Updates (2025/05/03)

Working in the integration of unit test and github actions to run tests every commit.

## Updates (2025/06/01)

Split nano grid back into it's own project and documentation
