...
function isAnagram(str1, str2) {
  ...
  <p>Output</p>
  <nn-code>${o.compressText(`"${s(n)}" = "${s(r)}" = ${d(n,r)}`)}</nn-code>
</nn-caja>
`,e};var a,p,i;c.parameters={...c.parameters,docs:{...(a=c.parameters)==null?void 0:a.docs,source:{originalSource:`args => {
  const {
    str1,
    str2
  } = args;
...
\`;
  return container;
}`,...(i=(p=c.parameters)==null?void 0:p.docs)==null?void 0:i.source}}};const l=["Anagram"];export{c as Anagram,l as __namedExportsOrder,$ as default};
