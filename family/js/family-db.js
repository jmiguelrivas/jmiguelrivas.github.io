    ...
    children: [
      {
        ...
        group: 'pareja',
        name: ['Eddy', 'Alberto'],
        familyName: [fn.diaz, fn.mejia],
        children: [
          {
            ...ID(),
            name: ['Enmanuel'],
            familyName: [fn.diaz, fn.ramirez],
          },
          {
            ...ID(),
            name: ['Edilí'],
                                  ...
                                  children: [
                                    {
                                      ...ID(),
                                      name: ['Christian'],
                                      familyName: [fn.grullon, fn.sierra],
                                      children: [
                                        {
                                          ...ID(),
                                          name: ['Ryan', 'Alejandro'],
                      ...
                      children: [
                        {
                          ...ID(),
                          name: ['Jasmin'],
                          familyName: [fn.ramirez, fn.fabre],
                        },
                      ],
                    },
                  ],
                                  ...
                                  children: [
                                    {
                                      ...
                                      group: 'pareja',
                                      name: ['Jeury'],
                                      familyName: [fn.batista, fn.null],
                                      children: [
                                        {
                                          name: ['Jeily'],
                                          familyName: [fn.batista, fn.perez],
                                        },
                                      ],
                                    },
                                  ],
