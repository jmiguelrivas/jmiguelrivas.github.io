...
class Spirit extends HTMLElement {
  ...
  static formatJs(text) {
    const computedText = Spirit.decompressText(
      Spirit.compressText(text)
        .replace(
        ...
        .replace(
          /(♥♥parenthesis-o♥♥|♥♥bracket-o♥♥|♥♥brace-o♥♥|♥♥parenthesis-c♥♥|♥♥bracket-c♥♥|♥♥brace-c♥♥)/g,
          match => {
